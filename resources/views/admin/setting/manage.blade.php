      ...
      <x-card.card-default class="static">
        ...
        <x-form action="{{ isset($setting) ? route('setting.update', $setting->id) : route('setting.store') }}"
          ...
          <div class="mt-4">
            ...
            <x-input.text-input id="name" class="mt-1 w-full" type="text" name="name" :value="old('name', $setting->name ?? '')"
          ...
          <div class="mt-4">
            ...
            <x-input.text-input id="alias" class="mt-1 w-full" type="text" name="alias" :value="old('alias', $setting->alias ?? '')"
              autofocus autocomplete="alias" />
            ...
            @if ($setting->banner->count())
              ...
              <div class="carousel w-full relative mt-2 border rounded-xl">
                @foreach ($setting->banner as $index => $bannerImage)
                  <div
                    class="carousel-item w-full flex justify-center h-[200px] {{ $index === 0 ? 'block' : 'hidden' }}"
                    data-slide="{{ $index }}">
                    <img src="{{ asset('storage/banner/' . $bannerImage->image) }}"
                      class="max-w-full max-h-full m-2 object-cover border rounded-xl" alt="Banner Image" />
                  </div>
                @endforeach
          ...
          <div class="mt-4">
            ...
            <x-input.text-input id="phone" class="mt-1 w-full" type="text" inputmode="numeric" name="phone"
              :value="old('phone', $setting->phone ?? '')" autofocus autocomplete="phone" />
          ...
          <div class="mt-4">
            ...
            <x-input.text-input id="address" class="mt-1 w-full" type="text" inputmode="numeric" name="address"
              :value="old('address', $setting->address ?? '')" autofocus autocomplete="address" />
          ...
          <div class="mt-4">
            ...
            <x-input.text-input id="instagram" class="mt-1 w-full" type="text" name="instagram" :value="old('instagram', $setting->instagram ?? '')"
          ...
          <div class="mt-4">
            ...
            <x-input.text-input id="x" class="mt-1 w-full" type="text" name="x" :value="old('x', $setting->x ?? '')"
              autofocus autocomplete="x" />
          ...
          <div class="mt-4">
            ...
            <x-input.text-input id="facebook" class="mt-1 w-full" type="text" name="facebook" :value="old('facebook', $setting->facebook ?? '')"
          ...
          <div class="mt-4">
            ...
            <x-input.text-input id="email" class="mt-1 w-full" type="email" name="email" :value="old('email', $setting->email ?? '')"
